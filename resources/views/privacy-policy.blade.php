    ...
    <div class="row">
        ...
        <div class="col-lg-9 line-h-more order-1 order-lg-2">
            ...
            <div class="shadow-sm rounded bg-white pt-5 pl-5 pr-5 pb-4">
                ...
                <p>Our Privacy Policy was posted on 13 September 2012 and last updated on 22 Mar 2020. It
                    governs the privacy terms of our website, located at TermsFeed.com, and the tools we provide
                    you (the "Website" or the "Service"). Any capitalized terms not defined in our Privacy
                    Policy, have the meaning as specified in our Terms of Use accessible at <a
                        href="https://termsfeed.com/legal/terms-of-use">https://termsfeed.com/legal/terms-of-use</a>
                </p>
                <h2 class="pt-3 pb-3">Your Privacy</h2>
                <p>Our Website follows all legal requirements to protect your privacy. Our Privacy Policy is a
                    legal statement that explains how we may collect information from you, how we may share your
                    information, and how you can limit our sharing of your information. You will see terms in
                    our Privacy Policy that are capitalized. These terms have meanings as described in the
                    Definitions section below.</p>
                <h2 class="pt-3 pb-3">Definitions</h2>
                <ul>
                    <li>
                        <strong>Personal Data:</strong> Personal Data means data about a living individual who
                    ...
                    <li>
                        <strong>Usage Data:</strong> Usage Data is data collected automatically either generated
                    ...
                    <li>
                        <strong>Data Controller:</strong> Data Controller means a natural or legal person who
                    ...
                    <li>
                        <strong>Data Processors (or Service Providers):</strong> Data Processor (or Service
                    ...
                    <li>
                        <strong>Data Subject:</strong> Data Subject is any living individual who is the subject
                        of Personal Data.
                    </li>
                    <li>
                        <strong>User:</strong> The User is the individual using our Service. The User
                ...
                <ul>
                    <li>
                        ...
                        <p>While using our Service, we may ask you to provide us with certain personally
                            ...
                            Email address, Name, Address, State, Province, ZIP/Postal code, City, Cookies and
                            Usage Data.</p>
                        <p>We may use your Personal Data to contact you with newsletters, marketing or
                            ...
                            unsubscribe link or instructions provided in any email we send.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <p>Examples of Cookies we use: <strong>session cookies</strong> (we use these cookies to
                            operate our Service) and <strong>preference cookies</strong> (we use these cookies
                ...
                <p>Your information, including Personal Data, may be transferred to — and maintained on —
                    ...
                    jurisdiction.</p>
                <p>We will take all steps reasonably necessary to ensure that your data is treated securely and
                ...
                <ul>
                    <li><strong>Business Transaction.</strong> If we are involved in a merger, acquisition or
                    ...
                    <li><strong>Disclosure for Law Enforcement.</strong> Under certain circumstances, we may be
                ...
                <p>The security of your data is important to us, but remember that no method of transmission
                    ...
                    absolute security.</p>
                <h2 class="pt-3 pb-3">Legal Basis for Processing Personal Data Under General Data Protection
                    Regulation (GDPR)</h2>
                <p>If you are from the European Economic Area (EEA), TermsFeed legal basis for collecting and
                ...
                <h2 class="pt-3 pb-3">Your Data Protection Rights Under General Data Protection Regulation
                    (GDPR)</h2>
                <p>If you are a resident of the European Economic Area (EEA), you have certain data protection
                    rights. TermsFeed aims to take reasonable steps to allow you to correct, amend, delete, or
                ...
                <ul>
                    <li>
                        <p><strong>The right to access, update or to delete</strong> the information we have on
                            you.</p>
                    </li>
                    <li>
                        <p><strong>The right of rectification.</strong> You have the right to have your
                            information rectified if that information is inaccurate or incomplete.</p>
                    </li>
                    <li>
                        <p><strong>The right to object.</strong> You have the right to object to our processing
                            of your Personal Data.</p>
                    </li>
                    <li>
                        <p><strong>The right of restriction.</strong> You have the right to request that we
                            restrict the processing of your personal information.</p>
                    </li>
                    <li>
                        <p><strong>The right to data portability.</strong> You have the right to be provided
                            with a copy of your Personal Data in a structured, machine-readable and commonly
                            used format.</p>
                    </li>
                    <li>
                        <p><strong>The right to withdraw consent.</strong> You also have the right to withdraw
                            your consent at any time where TermsFeed relied on your consent to process your
                ...
                <h2 class="pt-3 pb-3">"Do Not Sell My Personal Information" Notice for California consumers
                    under California Consumer Privacy Act (CCPA)</h2>
                <p>Under the CCPA, California consumers have the right to:</p>
                <ul>
                    <li>Request that a business that collects a consumer's personal data disclose the categories
                ...
                <p>If you make a request, we have 30 days to respond to you. If you would like to exercise any
                ...
                <ul>
                    <li>
                        ...
                        <p>You can opt-out of having made your activity on the Service available to Google
                            ...
                            sharing information with Google Analytics about visits activity.</p>
                ...
                <ul>
                    <li>
                        <strong>PayPal or Braintree.</strong> Their Privacy Policy can be viewed at <a
                            href="https://www.paypal.com/webapps/mpp/ua/privacy-full">https://www.paypal.com/webapps/mpp/ua/privacy-full</a>
                    </li>
                    <li>
                        <strong>FastSpring.</strong> Their Privacy Policy can be viewed at <a
                            href=" http://fastspring.com/privacy/">http://fastspring.com/privacy/</a>
                    </li>
                </ul>
                ...
                <p>If you have any questions about this Privacy Policy, please contact us by using the contact
                    information <a href="/contact">we provided on our Contact page</a>.</p>
            </div>
        </div>
